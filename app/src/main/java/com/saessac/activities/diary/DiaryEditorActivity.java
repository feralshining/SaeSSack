...
import com.saessac.activities.diary.DiaryStatsActivity;
        ...
        saveBTN.setOnClickListener(v -> {
            ...
            executorService.execute(() -> {
                ...
                try {
                    ...
                    runOnUiThread(() -> {
                        if (isSuccess) {
                            SaessacUI.openActivity(DiaryEditorActivity.this, DiaryStatsActivity.class,
                                    R.anim.slide_in_right, R.anim.slide_out_left);
                        } else {
                            Toast.makeText(DiaryEditorActivity.this, "일기를 저장할 수 없습니다. 문제가 지속되면 관리자에게 문의하세요.",
