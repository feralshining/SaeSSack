...
import com.saessac.activities.diary.DiaryEditorActivity;
import com.saessac.activities.todo.TodoListActivity;
        ...
        myCalendarView.setOnDateChangeListener((view, year, month, dayOfMonth) -> {
            if (isDoubleClicked()) {
                ...
                todolistBTN.setOnClickListener(v -> {
                    SaessacUI.openActivity(this, TodoListActivity.class, R.anim.slide_in_right,
                ...
                diaryBTN.setOnClickListener(v -> {
                    SaessacUI.openActivity(this, DiaryEditorActivity.class, R.anim.slide_in_right,
                            R.anim.slide_out_left);
                    dialog.dismiss();
                });
