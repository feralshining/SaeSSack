        ...
        requestBTN.setOnClickListener(v -> {
            ...
            executorService.execute(() -> {
                try {
                    ...
                    if (count > 0) {
                        runOnUiThread(() -> {
                            SaessacUI.showText(EventGoodRequestActivity.this, "이미 굿즈 신청하셨습니다.");
                        });
                        return;
                    }
                    ...
                    runOnUiThread(() -> {
                        if (isSuccess) {
                            ...
                            SaessacUI.openActivity(EventGoodRequestActivity.this, EventActivity.class,
                                    R.anim.slide_in_right, R.anim.slide_out_left);
                        } else {
                            SaessacUI.showText(EventGoodRequestActivity.this,
