        ...
        shareBTN.setOnClickListener(v -> {
            ...
            executorService.execute(() -> {
                try {
                    ...
                    if (!isValid) {
                        runOnUiThread(() -> {
                            SaessacUI.showText(SharingUUIDActivity.this, "유효하지 않은 UUID입니다.");
                        });
                        return;
                    }
                    ...
                    runOnUiThread(() -> {
                        ...
                        SaessacUI.showText(SharingUUIDActivity.this, "공유가 완료되었습니다.");
                        SaessacUI.openActivity(SharingUUIDActivity.this, MainActivity.class, R.anim.slide_in_right,
                                R.anim.slide_out_left);
                    });
                } catch (Exception e) {
                    runOnUiThread(() -> {
                        SaessacUI.showText(SharingUUIDActivity.this, "오류가 발생했습니다.");
                    });
                }
            });
        });
